...
import { setBun, setIngredients } from "../../services/slices/orderSlice";
...
const BurgerIngredients = () => {
  ...
  const handleScroll = () => {
    ...
    console.log(visibleAreaTop, visibleAreaBottom, visibleAreaTop-visibleAreaBottom)
    console.log(bunsY, saucesY, mainsY)
